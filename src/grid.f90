...
contains
  ...
  subroutine init_grid_cartesian(G, aqrs, bqrs)
...
!!! these will be computed using finite difference routines applied to the x array
  ...
  subroutine init_grid_curve(G, aqrs, bqrs, lc, rc, profile_type, profile_path, &
       topography_type,topography_path, use_mms, use_topography, topo, ny, nz)
...
!!$    stop
  ...
  subroutine init_grid_from_file(id, G, aqrs, bqrs)
